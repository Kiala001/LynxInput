...
"(react:main-thread)/./src/assets/img/bar.png": (function (module) {
...
"(react:main-thread)/./src/assets/img/search-Photoroom.png": (function (module, __unused_webpack_exports, __webpack_require__) {
...
/* ESM import */var _lynx_performance_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("(react:main-thread)/./node_modules/@lynx-js/react/runtime/lib/lynx/performance.js");
...
/* ESM import */var _isMainThreadHydrationFinished_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("(react:main-thread)/./node_modules/@lynx-js/react/runtime/lib/lifecycle/patch/isMainThreadHydrationFinished.js");
/* ESM import */var _snapshotPatchApply_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__("(react:main-thread)/./node_modules/@lynx-js/react/runtime/lib/lifecycle/patch/snapshotPatchApply.js");
...
function updateMainThread({ data, patchOptions }) {
    if (patchOptions.reloadVersion < (0,_pass_js__WEBPACK_IMPORTED_MODULE_5__.getReloadVersion)()) return;
    (0,_lynx_performance_js__WEBPACK_IMPORTED_MODULE_3__.setPipeline)(patchOptions.pipelineOptions);
    (0,_lynx_performance_js__WEBPACK_IMPORTED_MODULE_3__.markTiming)(_lynx_performance_js__WEBPACK_IMPORTED_MODULE_3__.PerformanceTimingKeys.mtsRenderStart);
    (0,_lynx_performance_js__WEBPACK_IMPORTED_MODULE_3__.markTiming)(_lynx_performance_js__WEBPACK_IMPORTED_MODULE_3__.PerformanceTimingKeys.parseChangesStart);
    const { patchList, flushOptions = {} } = JSON.parse(data);
    (0,_lynx_performance_js__WEBPACK_IMPORTED_MODULE_3__.markTiming)(_lynx_performance_js__WEBPACK_IMPORTED_MODULE_3__.PerformanceTimingKeys.parseChangesEnd);
    (0,_lynx_performance_js__WEBPACK_IMPORTED_MODULE_3__.markTiming)(_lynx_performance_js__WEBPACK_IMPORTED_MODULE_3__.PerformanceTimingKeys.patchChangesStart);
    for (const { snapshotPatch, workletRefInitValuePatch } of patchList){
        ...
        if (snapshotPatch) (0,_snapshotPatchApply_js__WEBPACK_IMPORTED_MODULE_7__.snapshotPatchApply)(snapshotPatch);
    ...
    (0,_lynx_performance_js__WEBPACK_IMPORTED_MODULE_3__.markTiming)(_lynx_performance_js__WEBPACK_IMPORTED_MODULE_3__.PerformanceTimingKeys.patchChangesEnd);
    (0,_lynx_performance_js__WEBPACK_IMPORTED_MODULE_3__.markTiming)(_lynx_performance_js__WEBPACK_IMPORTED_MODULE_3__.PerformanceTimingKeys.mtsRenderEnd);
    if (patchOptions.isHydration) (0,_isMainThreadHydrationFinished_js__WEBPACK_IMPORTED_MODULE_6__.setMainThreadHydrationFinished)(true);
    ...
    __FlushElementTree(_snapshot_js__WEBPACK_IMPORTED_MODULE_4__.__page, flushOptions);
}
function injectUpdateMainThread() {
    Object.assign(globalThis, {
        [_lifecycleConstant_js__WEBPACK_IMPORTED_MODULE_1__.LifecycleConstant.patchUpdate]: updateMainThread
    });
}
/**
 * @internal
...
/* ESM import */var _utils_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__("(react:main-thread)/./node_modules/@lynx-js/react/runtime/lib/utils.js");
/* ESM import */var _performance_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__("(react:main-thread)/./node_modules/@lynx-js/react/runtime/lib/lynx/performance.js");
...
function ssrEncode() {
    ...
    const oldToJSON = _snapshot_js__WEBPACK_IMPORTED_MODULE_8__.SnapshotInstance.prototype.toJSON;
    _snapshot_js__WEBPACK_IMPORTED_MODULE_8__.SnapshotInstance.prototype.toJSON = function() {
        return [
            this.type,
            this.__id,
            this.__elements
    ...
    try {
        ...
        _snapshot_js__WEBPACK_IMPORTED_MODULE_8__.SnapshotInstance.prototype.toJSON = oldToJSON;
    }
}
function ssrHydrate(info) {
    ...
    (0,_snapshot_js__WEBPACK_IMPORTED_MODULE_8__.setupPage)(nativePage);
...
function renderPage(data) {
    ...
    (0,_snapshot_js__WEBPACK_IMPORTED_MODULE_8__.setupPage)(__CreatePage('0', 0));
    ...
    (0,_snapshot_workletRef_js__WEBPACK_IMPORTED_MODULE_11__.applyRefQueue)();
...
function updatePage(data, options) {
    ...
    if (typeof data == 'object' && !(0,_utils_js__WEBPACK_IMPORTED_MODULE_9__.isEmptyObject)(data)) {
        var _lynx;
        var ___initData;
    ...
    if (!_lifecycle_event_jsReady_js__WEBPACK_IMPORTED_MODULE_1__.isJSReady) {
        ...
        (0,_root_js__WEBPACK_IMPORTED_MODULE_7__.setRoot)(new _snapshot_js__WEBPACK_IMPORTED_MODULE_8__.SnapshotInstance('root'));
        _root_js__WEBPACK_IMPORTED_MODULE_7__.__root.__jsx = oldRoot.__jsx;
        (0,_performance_js__WEBPACK_IMPORTED_MODULE_10__.setPipeline)(options === null || options === void 0 ? void 0 : options.pipelineOptions);
        (0,_performance_js__WEBPACK_IMPORTED_MODULE_10__.markTiming)(_performance_js__WEBPACK_IMPORTED_MODULE_10__.PerformanceTimingKeys.updateDiffVdomStart);
        ...
        _list_js__WEBPACK_IMPORTED_MODULE_5__.__pendingListUpdates.flush();
        (0,_snapshot_workletRef_js__WEBPACK_IMPORTED_MODULE_11__.applyRefQueue)();
        (0,_performance_js__WEBPACK_IMPORTED_MODULE_10__.markTiming)(_performance_js__WEBPACK_IMPORTED_MODULE_10__.PerformanceTimingKeys.updateDiffVdomEnd);
    }
    if (options) __FlushElementTree(_snapshot_js__WEBPACK_IMPORTED_MODULE_8__.__page, options);
...
/* ESM import */var _assets_img_search_Photoroom_png__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("(react:main-thread)/./src/assets/img/search-Photoroom.png");
/* ESM import */var _assets_img_bar_png__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("(react:main-thread)/./src/assets/img/bar.png");





const __snapshot_835da_85fa1_1 = /*#__PURE__*/ (__webpack_require__("(react:main-thread)/./node_modules/@lynx-js/react/runtime/lib/internal.js")/* .createSnapshot */.createSnapshot)("__snapshot_835da_85fa1_1", function() {
...
const __snapshot_835da_85fa1_4 = /*#__PURE__*/ (__webpack_require__("(react:main-thread)/./node_modules/@lynx-js/react/runtime/lib/internal.js")/* .createSnapshot */.createSnapshot)("__snapshot_835da_85fa1_4", function() {
    const pageId = (__webpack_require__("(react:main-thread)/./node_modules/@lynx-js/react/runtime/lib/internal.js")/* .__pageId */.__pageId);
...
const __snapshot_835da_85fa1_5 = /*#__PURE__*/ (__webpack_require__("(react:main-thread)/./node_modules/@lynx-js/react/runtime/lib/internal.js")/* .createSnapshot */.createSnapshot)("__snapshot_835da_85fa1_5", function() {
    const pageId = (__webpack_require__("(react:main-thread)/./node_modules/@lynx-js/react/runtime/lib/internal.js")/* .__pageId */.__pageId);
    const el = __CreateText(pageId);
...
const __snapshot_835da_85fa1_6 = /*#__PURE__*/ (__webpack_require__("(react:main-thread)/./node_modules/@lynx-js/react/runtime/lib/internal.js")/* .createSnapshot */.createSnapshot)("__snapshot_835da_85fa1_6", function() {
    const pageId = (__webpack_require__("(react:main-thread)/./node_modules/@lynx-js/react/runtime/lib/internal.js")/* .__pageId */.__pageId);
    const el = __CreateText(pageId);
...
const __snapshot_835da_85fa1_3 = /*#__PURE__*/ (__webpack_require__("(react:main-thread)/./node_modules/@lynx-js/react/runtime/lib/internal.js")/* .createSnapshot */.createSnapshot)("__snapshot_835da_85fa1_3", function() {
    const pageId = (__webpack_require__("(react:main-thread)/./node_modules/@lynx-js/react/runtime/lib/internal.js")/* .__pageId */.__pageId);
    const el = __CreateView(pageId);
...
const __snapshot_835da_85fa1_2 = /*#__PURE__*/ (__webpack_require__("(react:main-thread)/./node_modules/@lynx-js/react/runtime/lib/internal.js")/* .createSnapshot */.createSnapshot)("__snapshot_835da_85fa1_2", function() {
    const pageId = (__webpack_require__("(react:main-thread)/./node_modules/@lynx-js/react/runtime/lib/internal.js")/* .__pageId */.__pageId);
...
const __snapshot_835da_85fa1_7 = /*#__PURE__*/ (__webpack_require__("(react:main-thread)/./node_modules/@lynx-js/react/runtime/lib/internal.js")/* .createSnapshot */.createSnapshot)("__snapshot_835da_85fa1_7", function() {
    const pageId = (__webpack_require__("(react:main-thread)/./node_modules/@lynx-js/react/runtime/lib/internal.js")/* .__pageId */.__pageId);
    const el = __CreateView(pageId);
    __SetClasses(el, "fab");
...
function App() {
    ...
    return /*#__PURE__*/ (0,_lynx_js_react_lepus_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)(_lynx_js_react_runtime_components__WEBPACK_IMPORTED_MODULE_1__.Page, {
        className: "App",
        children: [
            /*#__PURE__*/ (0,_lynx_js_react_lepus_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)(__snapshot_835da_85fa1_1, {
                values: [
            ...
            /*#__PURE__*/ (0,_lynx_js_react_lepus_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)(__snapshot_835da_85fa1_2, {
                children: products.map((product, index)=>/*#__PURE__*/ (0,_lynx_js_react_lepus_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)(__snapshot_835da_85fa1_3, {
                        children: [
                            /*#__PURE__*/ (0,_lynx_js_react_lepus_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)(__snapshot_835da_85fa1_4, {
                            ...
                            /*#__PURE__*/ (0,_lynx_js_react_lepus_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)(__snapshot_835da_85fa1_5, {
                            ...
                            /*#__PURE__*/ (0,_lynx_js_react_lepus_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)(__snapshot_835da_85fa1_6, {
            ...
            /*#__PURE__*/ (0,_lynx_js_react_lepus_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)(__snapshot_835da_85fa1_7, {
                values: [
...
(() => {
var installedChunks = __webpack_require__.hmrS_importScripts = __webpack_require__.hmrS_importScripts || {"main__main-thread": 1,};
...
;
//# sourceMappingURL=http://192.168.10.94:3000/main/main-thread.js.map