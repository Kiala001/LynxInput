...
export function Home(){
  ...
  const [searchValue, setSearchValue] = useState<string>('');
    ...
    function handleSearchInput(event: { type: string; detail: { value: string } }) {
        setSearchValue(event.detail.value);
    }
    const products = [
        { name: 'Arroz Carmita', code: '9384857884758' },
    ...
    return(
      ...
      <input className='input-search' type='text' placeholder="Escreva algo..."/>
      ...
      {/*<view className='fab' bindtap={handleSearchInput}>
